                    ...
                    {nowPlayingMovies.map((movie) => {
                        ...
                        return (
                            <div
                                ...
                                className={`relative max-w-40 cursor-pointer transition duration-300 rounded-lg overflow-hidden
                                    group-hover:not-hover:opacity-40 hover:-translate-y-1
                                    ${isSelected ? "ring ring-primary ring-offset-2" : ""}`}
                            >
                                <div className="relative rounded-lg overflow-hidden">
                                    {/* Uncomment this if images are available */}
                        ...
                        {Object.entries(dateTimeSelection).map(([date, times]) => (
                            <li key={date}>
                                ...
                                <div className="flex flex-wrap gap-2 mt-1 text-sm">
                                    {times.map((time) => (
                                        <div key={`${date}-${time}`} className="border border-primary px-2 py-1 flex items-center rounded">
                                            <span>{time}</span>
                                            <DeleteIcon
